...
class UserController extends AdminController {
    ...
    */
    ...
    {
        $users = User::select(array('users.id','users.name','users.email','users.usable', 'users.created_at'));

        return Datatables::of($users)
            ->edit_column('usable', '@if ($usable=="1") <span class="glyphicon glyphicon-ok"></span> @else <span class=\'glyphicon glyphicon-remove\'></span> @endif')
